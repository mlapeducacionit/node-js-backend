...
// CRUD Productos (PRIVADO)
// TODO: Validaciones de productos
adminProductosRouter.get('/productos', controladores.getAll ) // http://localhost:8080/admin/productos
adminProductosRouter.get('/productos/:id', controladores.getOne ) // http://localhost:8080/admin/productos/1
